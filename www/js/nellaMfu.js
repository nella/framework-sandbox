...
jQuery.fn.nellaMultipleFileUploader = function(options) {
	...
	options = jQuery.extend({
		templates: {
			...
			removeItemButton: '<a href="#" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-icon-only ui-state-focus remove-button" role="button" aria-disabled="false" title="remove"><span class="ui-button-icon-primary ui-icon ui-icon-trash"></span><span class="ui-button-text">remove</span></a>'
		},
		thumbnail: {
			width: 128,
			height: 128
